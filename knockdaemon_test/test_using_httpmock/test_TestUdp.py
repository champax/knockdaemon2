...
from knockdaemon.Tests.TestHelpers import expect_disco

from knockdaemon.Tests.TestHelpers import expect_value
from knockdaemon.Transport.HttpAsyncTransport import HttpAsyncTransport
from knockdaemon_test.ForTest.UdpClient import UdpClient
...
class TestUdp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Awful hack for tests (we may have a KnockDaemon running on the machine we are running test)
